# -*- coding: utf-8 -*-
"""Estadística_177735.ipynb
Gerardo Gael Elias Delgadillo - 177735
Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1McbYgLFeltF7zXiz0_ciPbt-Dw1fSoqq
"""
...
# Histograma altura (requiere matplotlib)
import matplotlib.pyplot as plt
plt.hist(altura, bins=5)  # bins define el número de barras en el histograma
plt.xlabel("Valor")
plt.ylabel("Altura")
plt.title("Histograma para la altura")
plt.show()
...
plt.xlabel("Valor")
plt.ylabel("Cintura")
plt.title("Histograma para la cintura")
plt.show()
